export class Urns {
  ...
  public static GROUP_SYNC_ENABLED = 'urn:perun:group:attribute-def:def:synchronizationEnabled';
  public static GROUP_LAST_SYNC_STATE = 'urn:perun:group:attribute-def:def:lastSynchronizationState';
  public static GROUP_LAST_SYNC_TIMESTAMP = 'urn:perun:group:attribute-def:def:lastSynchronizationTimestamp';
