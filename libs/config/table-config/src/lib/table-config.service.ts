...
export const TABLE_FACILITY_HOSTS_LIST = '41';
export const TABLE_FACILITY_BLACKLIST_LIST = '42';
export const TABLE_FACILITY_SECURITY_TEAMS_LIST = '43';
export const TABLE_MEMBER_APPLICATIONS_DETAILED = '44';
export const TABLE_MEMBER_APPLICATIONS_NORMAL = '45';
export const TABLE_ADMIN_SERVICES = '46';
export const TABLE_ADMIN_USER_RESOURCES_LIST = '47';
export const TABLE_MEMBER_RESOURCE_LIST = '48';
