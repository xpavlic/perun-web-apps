(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vos-vos-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApplicationDetailComponent = /** @class */ (function () {
                ...
                ApplicationDetailComponent.prototype.getLabel = function (formItem) {
                ...
                ApplicationDetailComponent.prototype.submittedBy = function () {
                    return this.application.createdBy.slice(this.application.createdBy.lastIndexOf('=') + 1, this.application.createdBy.length);
                };
                ApplicationDetailComponent.prototype.getModifiedAtName = function (modifiedBy) {
                ...
                ApplicationDetailComponent.prototype.resendNotification = function () {
                ...
                ApplicationDetailComponent.prototype.deleteApplication = function () {
                    var _this = this;
                    this.registrarService.deleteApplication(this.application.id).subscribe(function (any) {
                        _this.translate.get('VO_DETAIL.APPLICATION.APPLICATION_DETAIL.DELETE_MESSAGE').subscribe(function (successMessage) {
                            _this.notificator.showSuccess(successMessage);
                            _this.router.navigateByUrl(_this.router.url.substring(0, _this.router.url.lastIndexOf('/')));
                        });
                    });
                };
                ApplicationDetailComponent.prototype.rejectApplication = function () {
                    var _this = this;
                    ...
                    dialogRef.afterClosed().subscribe(function (value) {
                        _this.loading = true;
                        _this.registrarService.getApplicationById(_this.application.id).subscribe(function (reloaded) {
                            _this.application = reloaded;
                            _this.loading = false;
                        });
                    });
                };
                ApplicationDetailComponent.prototype.approveApplication = function () {
                    var _this = this;
                    this.registrarService.approveApplication(this.application.id).subscribe(function (application) {
                        _this.translate.get('VO_DETAIL.APPLICATION.APPLICATION_DETAIL.APPROVE_MESSAGE').subscribe(function (successMessage) {
                            _this.notificator.showSuccess(successMessage);
                        });
                        _this.loading = true;
                        _this.registrarService.getApplicationById(_this.application.id).subscribe(function (reloaded) {
                ...
                ApplicationDetailComponent.prototype.verifyApplication = function () {
                    var _this = this;
                    this.registrarService.verifyApplication(this.application.id).subscribe(function (application) {
                        _this.translate.get('VO_DETAIL.APPLICATION.APPLICATION_DETAIL.VERIFY_MESSAGE').subscribe(function (successMessage) {
                            _this.notificator.showSuccess(successMessage);
                        });
                        _this.loading = true;
                        _this.registrarService.getApplicationById(_this.application.id).subscribe(function (reloaded) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var ApplicationFormListComponent = /** @class */ (function () {
                ...
                ApplicationFormListComponent.prototype.ngOnChanges = function (changes) {
                    this.dataSource = this.applicationFormItems;
                    this.changeDetectorRef.detectChanges(); // fix - when data in table changes, error appears
                };
                ApplicationFormListComponent.prototype.edit = function (applicationFormItem) {
                    var _this = this;
                    ...
                    editDialog.afterClosed().subscribe(function (isChanged) {
                        if (isChanged) {
                            _this.applicationForm.group ? _this.getFormItemsForGroup() : _this.getFormItemsForVo();
                        }
                    });
                };
                ApplicationFormListComponent.prototype.delete = function (applicationFormItem) {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (deleteItem) {
                        if (deleteItem) {
                            ...
                            _this.decreaseOrdnums(applicationFormItem.ordnum);
                            if (_this.applicationForm.group) {
                                _this.registrarService.updateFormItemsForGroup(_this.applicationForm.group.id, _this.applicationFormItems).subscribe(function () {
                                    _this.successDeleteNotification();
                                    _this.getFormItemsForGroup();
                                });
                            }
                            else {
                                _this.registrarService.updateFormItemsForVo(_this.applicationForm.vo.id, _this.applicationFormItems).subscribe(function () {
                                    _this.successDeleteNotification();
                                    _this.getFormItemsForVo();
                                });
                            }
                        }
                    });
                };
                ApplicationFormListComponent.prototype.drop = function (event) {
                    var _this = this;
                    this.dragDisabled = true;
                    var prevIndex = this.applicationFormItems.findIndex(function (d) { return d === event.item.data; });
                    ...
                    if (this.applicationForm.group) {
                        this.registrarService.updateFormItemsForGroup(this.applicationForm.group.id, this.applicationFormItems).subscribe(function () {
                            _this.applicationFormItemsChange.emit(_this.applicationFormItems);
                        });
                    }
                    else {
                ...
                ApplicationFormListComponent.prototype.getLocalizedOptions = function (applicationFormItem) {
                    if (applicationFormItem.i18n[this.translate.getDefaultLang()]) {
                        ...
                        if (options !== null && options !== '') {
                            var labels = [];
                            for (var _i = 0, _a = options.split('|'); _i < _a.length; _i++) {
                                var item = _a[_i];
                ...
                ApplicationFormListComponent.prototype.updateDataSource = function () {
                    this.dataSource = this.applicationFormItems;
                    this.applicationFormItemsChange.emit(this.applicationFormItems);
                    this.changeDetectorRef.detectChanges(); // fix - when data in table changes, error appears
                    this.table.renderRows();
                };
                ApplicationFormListComponent.prototype.decreaseOrdnums = function (index) {
                    for (var i = index + 1; i < this.applicationFormItems.length; i++) {
                        this.applicationFormItems[i].ordnum--;
                    }
                };
                ApplicationFormListComponent.prototype.getLocalizedLabel = function (applicationFormItem) {
                    if (applicationFormItem.i18n[this.translate.getDefaultLang()]) {
                        return applicationFormItem.i18n[this.translate.getDefaultLang()].label;
                    }
                    return applicationFormItem.shortname;
                };
                ApplicationFormListComponent.prototype.getFormItemsForVo = function () {
                    var _this = this;
                    this.registrarService.getFormItemsForVo(this.applicationForm.vo.id).subscribe(function (formItems) {
                        _this.applicationFormItems = formItems;
                        _this.updateDataSource();
                    });
                };
                ApplicationFormListComponent.prototype.getFormItemsForGroup = function () {
                    var _this = this;
                ...
                ApplicationFormListComponent.prototype.successDeleteNotification = function () {
                    var _this = this;
            ...
            ApplicationFormListComponent.ctorParameters = function () { return [
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_8__["RegistrarService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApplicationFormPreviewComponent = /** @class */ (function () {
                ...
                ApplicationFormPreviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (params) {
                        var voId = params['voId'];
                        var groupId = params['groupId'];
                        if (groupId) {
                            _this.registrarService.getFormItemsForGroup(groupId).subscribe(function (formItems) {
                                _this.applicationFormItems = formItems;
                                _this.loading = false;
                            });
                        }
                        else {
                            _this.registrarService.getFormItemsForVo(voId).subscribe(function (formItems) {
                                _this.applicationFormItems = formItems;
                                _this.loading = false;
                            });
                        }
                ...
                ApplicationFormPreviewComponent.prototype.switchToInitial = function () {
                    this.initialPage = true;
                };
                ApplicationFormPreviewComponent.prototype.switchToExtension = function () {
                    this.initialPage = false;
                };
                ApplicationFormPreviewComponent.prototype.switchToEnglish = function () {
                    this.language = 'en';
                };
                ApplicationFormPreviewComponent.prototype.switchToCzech = function () {
                    this.language = 'cs';
                };
                ApplicationFormPreviewComponent.prototype.getLocalizedOptions = function (applicationFormItem) {
                ...
                ApplicationFormPreviewComponent.prototype.isChoosenType = function (applicationFormItem) {
                    for (var _i = 0, _a = applicationFormItem.applicationTypes; _i < _a.length; _i++) {
                        var type = _a[_i];
                ...
                ApplicationFormPreviewComponent.prototype.getLocalizedLabel = function (applicationFormItem) {
                    if (applicationFormItem.i18n[this.language]) {
                        return applicationFormItem.i18n[this.language].label;
                    }
                    return applicationFormItem.shortname;
                };
                ApplicationFormPreviewComponent.prototype.getLocalizedHint = function (applicationFormItem) {
                    if (applicationFormItem.i18n[this.language]) {
            ...
            ApplicationFormPreviewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApplicationsListComponent = /** @class */ (function () {
                ...
                Object.defineProperty(ApplicationsListComponent.prototype, "matSort", {
                    set: function (ms) {
                        this.sort = ms;
                        this.setDataSource();
                    },
                ...
                ApplicationsListComponent.prototype.ngOnChanges = function (changes) {
                    this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.applications);
                    this.setDataSource();
                    this.dataSource.filter = this.filterValue;
                };
                ApplicationsListComponent.prototype.setDataSource = function () {
                    if (!!this.dataSource) {
                ...
                ApplicationsListComponent.prototype.getFriendlyName = function (modifiedBy) {
                    var index = modifiedBy.lastIndexOf('/CN=');
                    if (index !== -1) {
                        var string = modifiedBy.slice(index + 4, modifiedBy.length).replace('/unstructuredName=', ' ');
                        if (string.lastIndexOf('\\') !== -1) {
                ...
                ApplicationsListComponent.prototype.selectApplication = function (application) {
                    if (this.group) {
            ...
            ApplicationsListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExpirationAttrValue = /** @class */ (function () {
                function ExpirationAttrValue() {
                }
                return ExpirationAttrValue;
            }());
            var ExpirationSettingsComponent = /** @class */ (function () {
                ...
                ExpirationSettingsComponent.prototype.ngOnInit = function () {
                    var loaPeriods = new Map();
                    this.LOAS.forEach(function (loa) { return loaPeriods.set(loa, ''); });
                ...
                ExpirationSettingsComponent.prototype.saveChanges = function () {
                    this.saveAttribute.emit(this.parseExpirationRulesAttribute());
                };
                ExpirationSettingsComponent.prototype.areChangesMade = function () {
                ...
                ExpirationSettingsComponent.prototype.parseExpirationRulesAttribute = function () {
                ...
                ExpirationSettingsComponent.prototype.parsePeriod = function (config) {
                ...
                ExpirationSettingsComponent.prototype.createInitConfiguration = function () {
                    var loaPeriods = new Map();
                    this.LOAS.forEach(function (loa) { return loaPeriods.set(loa, ''); });
                    return {
                        enabled: false,
                ...
                ExpirationSettingsComponent.prototype.unParseAttrValue = function (value) {
                ...
                ExpirationSettingsComponent.prototype.setPeriodValues = function (value, config) {
                    config.enabled = true;
                ...
                ExpirationSettingsComponent.prototype.setDoNotAllowLoasValues = function (value, config) {
                    var loas = [];
                    value.doNotAllowLoa.split(',').forEach(function (l) { return loas.push(parseInt(l.trim(), 10)); });
                ...
                ExpirationSettingsComponent.prototype.setDoNotExtendLoasValues = function (value, config) {
                    var loas = [];
                    value.doNotExtendLoa.split(',').forEach(function (l) { return loas.push(parseInt(l.trim(), 10)); });
                ...
                ExpirationSettingsComponent.prototype.setGracePeriodValues = function (value, config) {
                ...
                ExpirationSettingsComponent.prototype.setSpecialLoaPeriodValues = function (value, config) {
                ...
                ExpirationSettingsComponent.prototype.parseDynamicPeriod = function (config) {
                    return '+' + config.periodDynamic + config.periodDynamicUnit;
                };
                ExpirationSettingsComponent.prototype.parseStaticPeriod = function (config) {
                    return config.periodStatic;
                };
                ExpirationSettingsComponent.prototype.parseDontAllowLoas = function (config) {
                    if (!config.doNotAllowLoasEnabled) {
                        return null;
                    }
                    var dontAllowLoas = '';
                    config.doNotAllowLoas.forEach(function (loa) { return dontAllowLoas += loa + ','; });
                ...
                ExpirationSettingsComponent.prototype.parseDontExtendLoas = function (config) {
                    if (!config.doNotExtendLoasEnabled) {
                        return null;
                    }
                    var dontExtendLoas = '';
                    config.doNotExtendLoas.forEach(function (loa) { return dontExtendLoas += loa + ','; });
                ...
                ExpirationSettingsComponent.prototype.parseGracePeriod = function (config) {
                    if (!config.gracePeriodEnabled) {
                        return null;
                    }
                    return config.gracePeriod + config.gracePeriodUnit;
                };
                ExpirationSettingsComponent.prototype.parseSpecialLoaPeriod = function (config) {
                ...
                ExpirationSettingsComponent.prototype.parseSpecialLoaPeriodStatic = function (config) {
                    return config.specialLoaPeriodStatic;
                };
                ExpirationSettingsComponent.prototype.parseSpecialLoaPeriodDynamic = function (config) {
                    return '+' + config.specialLoaPeriodDynamic + config.specialLoaPeriodDynamicUnit;
                };
                ExpirationSettingsComponent.prototype.parseAttributeValueFromConfig = function (config) {
                    if (!config.enabled) {
                        return null;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupsTreeComponent = /** @class */ (function () {
                ...
                GroupsTreeComponent.prototype.ngOnChanges = function (changes) {
                    this.createGroupTrees(this.groups);
                    if (this.expandAll) {
                        this.treeControl.expandAll();
                    }
                };
                GroupsTreeComponent.prototype.createGroupTrees = function (groups) {
                ...
                GroupsTreeComponent.prototype.getParentNode = function (node) {
                ...
                GroupsTreeComponent.prototype.checkRootNodeSelection = function (node) {
                    var _this = this;
                    var nodeSelected = this.selection.isSelected(node);
                    var descendants = this.treeControl.getDescendants(node);
                    var descAllSelected = descendants.every(function (child) { return _this.selection.isSelected(child); });
                    if (nodeSelected && !descAllSelected) {
                        this.selection.deselect(node);
                    }
                };
                GroupsTreeComponent.prototype.checkAllParentsSelection = function (node) {
                ...
                GroupsTreeComponent.prototype.leafItemSelectionToggle = function (node) {
                    this.selection.toggle(node);
                    this.checkAllParentsSelection(node);
                };
                GroupsTreeComponent.prototype.descendantsPartiallySelected = function (node) {
                    var _this = this;
                    var descendants = this.treeControl.getDescendants(node);
                    var result = descendants.some(function (child) { return _this.selection.isSelected(child); });
                    return result && !this.selection.isSelected(node);
                };
                GroupsTreeComponent.prototype.itemSelectionToggle = function (node) {
                    var _a, _b;
                    var _this = this;
                    this.selection.toggle(node);
                    var descendants = this.treeControl.getDescendants(node);
                    this.selection.isSelected(node)
                        ? (_a = this.selection).select.apply(_a, descendants) : (_b = this.selection).deselect.apply(_b, descendants);
                    // Force update for the parent
                    descendants.every(function (child) { return _this.selection.isSelected(child); });
                    this.checkAllParentsSelection(node);
                };
                GroupsTreeComponent.prototype.onMoveGroup = function (group) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
            var MemberGroupListComponent = /** @class */ (function () {
                ...
                Object.defineProperty(MemberGroupListComponent.prototype, "matSort", {
                    set: function (ms) {
                        this.sort = ms;
                        this.setDataSource();
                    },
                ...
                MemberGroupListComponent.prototype.ngOnChanges = function (changes) {
                    this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.groups);
                    this.setDataSource();
                };
                MemberGroupListComponent.prototype.setDataSource = function () {
                    if (!!this.dataSource) {
                        this.dataSource.sort = this.sort;
                        this.dataSource.paginator = this.paginator;
                        this.dataSource.filter = this.filterValue;
                ...
                MemberGroupListComponent.prototype.isAllSelected = function () {
                    var numSelected = this.selection.selected.length;
                    var numRows = this.dataSource.data.length;
                    return numSelected === numRows;
                };
                MemberGroupListComponent.prototype.masterToggle = function () {
                    var _this = this;
                    this.isAllSelected() ?
                        this.selection.clear() :
                        this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
                };
                MemberGroupListComponent.prototype.checkboxLabel = function (row) {
                    if (!row) {
                        return (this.isAllSelected() ? 'select' : 'deselect') + " all";
                    }
                    return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.id + 1);
                };
                MemberGroupListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.params.subscribe(function (parentParams) { return _this.memberId = parentParams['memberId']; });
                };
                MemberGroupListComponent.prototype.ngAfterViewInit = function () {
                    this.dataSource.paginator = this.paginator;
                };
                return MemberGroupListComponent;
            }());
            MemberGroupListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MembersListComponent = /** @class */ (function () {
                ...
                Object.defineProperty(MembersListComponent.prototype, "matSort", {
                    set: function (ms) {
                        this.sort = ms;
                        this.setDataSource();
                    },
                ...
                MembersListComponent.prototype.setDataSource = function () {
                    var _this = this;
                    this.displayedColumns = this.displayedColumns.filter(function (x) { return !_this.hideColumns.includes(x); });
                    if (!!this.dataSource) {
                        this.dataSource.sort = this.sort;
                ...
                MembersListComponent.prototype.ngOnChanges = function (changes) {
                    var _this = this;
                    this.displayedColumns = this.displayedColumns.filter(function (x) { return !_this.hideColumns.includes(x); });
                    this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.members);
                    this.setDataSource();
                };
                MembersListComponent.prototype.isAllSelected = function () {
                    var numSelected = this.selection.selected.length;
                    var numRows = this.dataSource.data.length;
                    return numSelected === numRows;
                };
                MembersListComponent.prototype.masterToggle = function () {
                    var _this = this;
                    this.isAllSelected() ?
                        this.selection.clear() :
                        this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
                };
                MembersListComponent.prototype.checkboxLabel = function (row) {
                    if (!row) {
                        return (this.isAllSelected() ? 'select' : 'deselect') + " all";
                    }
                    return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.id + 1);
                };
                MembersListComponent.prototype.changeStatus = function (event, member) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationListComponent = /** @class */ (function () {
                ...
                Object.defineProperty(NotificationListComponent.prototype, "matSort", {
                    set: function (ms) {
                        this.sort = ms;
                        this.setDataSource();
                    },
                ...
                NotificationListComponent.prototype.ngOnChanges = function () {
                ...
                NotificationListComponent.prototype.isAllSelected = function () {
                    var numSelected = this.selection.selected.length;
                    var numRows = this.dataSource.data.length;
                    return numSelected === numRows;
                };
                NotificationListComponent.prototype.masterToggle = function () {
                    var _this = this;
                    this.isAllSelected() ?
                        this.selection.clear() :
                        this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
                ...
                NotificationListComponent.prototype.checkboxLabel = function (row) {
                    if (!row) {
                        return (this.isAllSelected() ? 'select' : 'deselect') + " all";
                    }
                    return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.id + 1);
                };
                NotificationListComponent.prototype.changeSending = function (applicationMail) {
                ...
                NotificationListComponent.prototype.openApplicationMailDetail = function (applicationMail) {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translate.get('VO_DETAIL.SETTINGS.NOTIFICATIONS.EDIT_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.selection.clear();
                            _this.selectionChange.emit(_this.selection);
                            _this.update();
                        }
                    });
                };
                NotificationListComponent.prototype.getMailType = function (applicationMail) {
                    var value = '';
                ...
                NotificationListComponent.prototype.toggle = function (row) {
                    this.selection.toggle(row);
                    this.selectionChange.emit(this.selection);
                };
                NotificationListComponent.prototype.updateTable = function (mails) {
                    this.applicationMails = mails;
                    this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.applicationMails);
                    this.setDataSource();
                };
                NotificationListComponent.prototype.setDataSource = function () {
                    if (!!this.dataSource) {
                        this.dataSource.sort = this.sort;
                        this.dataSource.paginator = this.paginator;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupDetailPageComponent = /** @class */ (function () {
                ...
                GroupDetailPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        var voId = params['voId'];
                        var groupId = params['groupId'];
                        _this.voService.getVoById(voId).subscribe(function (vo) {
                            _this.vo = vo;
                            _this.groupService.getGroupById(groupId).subscribe(function (group) {
                                _this.group = group;
                                var voSideMenuItem = _this.sideMenuItemService.parseVo(vo);
                                var groupSideMenuItem = _this.sideMenuItemService.parseGroup(group);
                                _this.sideMenuService.setAccessMenuItems([voSideMenuItem, groupSideMenuItem]);
                            });
                        });
                    });
                };
            ...
            GroupDetailPageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var GroupOverviewComponent = /** @class */ (function () {
                ...
                GroupOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        _this.groupId = params['groupId'];
                        _this.groupService.getGroupById(_this.groupId).subscribe(function (group) {
                            _this.group = group;
                            if (_this.group.parentGroupId !== null) {
                                _this.loadParentGroupData();
                            }
                            else {
                ...
                GroupOverviewComponent.prototype.loadParentGroupData = function () {
                    var _this = this;
                ...
                GroupOverviewComponent.prototype.initNavItems = function () {
                    this.navItems = [
                        {
                            icon: 'user-white.svg',
            ...
            GroupOverviewComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupSettingsApplicationFormComponent = /** @class */ (function () {
                ...
                GroupSettingsApplicationFormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                    this.route.parent.parent.params.subscribe(function (params) {
                        _this.voId = params['voId'];
                        _this.groupId = params['groupId'];
                        // FIXME this might not work in case of some race condition (other request finishes sooner)
                        _this.apiRequest.dontHandleErrorForNext();
                        _this.registrarService.getApplicationFormForGroup(_this.groupId, false).subscribe(function (form) {
                            _this.applicationForm = form;
                            _this.registrarService.getFormItemsForGroup(_this.groupId).subscribe(function (formItems) {
                                _this.applicationFormItems = formItems;
                                _this.loading = false;
                            });
                        }, function (error) {
                            if (error.name === 'FormNotExistsException') {
                                _this.noApplicationForm = true;
                                _this.loading = false;
                            }
                            else {
                                _this.notificator.showRPCError(error);
                            }
                        });
                    });
                };
                GroupSettingsApplicationFormComponent.prototype.add = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.registrarService.getFormItemsForGroup(_this.groupId).subscribe(function (formItems) {
                                _this.applicationFormItems = formItems;
                                var editDialog = _this.dialog.open(_shared_components_dialogs_edit_application_form_item_dialog_edit_application_form_item_dialog_component__WEBPACK_IMPORTED_MODULE_7__["EditApplicationFormItemDialogComponent"], {
                                    width: '600px',
                                    height: '600px',
                                    data: { voId: _this.voId,
                                        groupId: _this.groupId,
                                        applicationFormItem: formItems[success.ordnum],
                                        applicationFormItems: _this.applicationFormItems }
                                });
                                editDialog.afterClosed().subscribe(function () {
                                    _this.updateFormItems();
                                });
                            });
                        }
                    });
                };
                GroupSettingsApplicationFormComponent.prototype.copy = function () {
                    var _this = this;
                ...
                GroupSettingsApplicationFormComponent.prototype.settings = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (newForm) {
                        if (newForm) {
                            _this.translate.get('GROUP_DETAIL.SETTINGS.APPLICATION_FORM.CHANGE_SETTINGS_SUCCESS').subscribe(function (successMessage) {
                                _this.notificator.showSuccess(successMessage);
                            });
                            _this.applicationForm = newForm;
                        }
                    });
                };
                GroupSettingsApplicationFormComponent.prototype.preview = function () {
                    this.router.navigate(['/organizations', this.voId, 'groups', this.groupId, 'settings', 'applicationForm', 'preview']);
                };
                GroupSettingsApplicationFormComponent.prototype.updateFormItems = function () {
                    var _this = this;
                    this.loading = true;
                ...
                GroupSettingsApplicationFormComponent.prototype.changeItems = function (applicationFormItemsChange) {
                    this.applicationFormItems = applicationFormItemsChange;
                };
                GroupSettingsApplicationFormComponent.prototype.createEmptyApplicationForm = function () {
                    var _this = this;
                    this.registrarService.createApplicationForm(this.groupId).subscribe(function () {
                        _this.noApplicationForm = false;
                        _this.ngOnInit();
                    });
                };
                return GroupSettingsApplicationFormComponent;
            }());
            GroupSettingsApplicationFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupSettingsAttributesComponent = /** @class */ (function () {
                function GroupSettingsAttributesComponent(route, attributesService, notificator, dialog, translate) {
                    ...
                    this.attributes = [];
                    this.filterValue = '';
                    this.translate.get('GROUP_DETAIL.SETTINGS.ATTRIBUTES.SUCCESS_SAVE').subscribe(function (value) { return _this.saveSuccessMessage = value; });
                    this.translate.get('GROUP_DETAIL.SETTINGS.ATTRIBUTES.SUCCESS_DELETE').subscribe(function (value) { return _this.deleteSuccessMessage = value; });
                }
                GroupSettingsAttributesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (params) {
                        _this.groupId = params['groupId'];
                        _this.refreshTable();
                ...
                GroupSettingsAttributesComponent.prototype.onCreate = function () {
                    var _this = this;
                ...
                GroupSettingsAttributesComponent.prototype.onSave = function () {
                    var _this = this;
                    // have to use this to update attribute with map in it, before saving it
                    this.list.updateMapAttributes();
                    this.attributesService.setAttributes(this.groupId, 'group', this.selection.selected).subscribe(function () {
                        _this.attributesService.getAllAttributes(_this.groupId, 'group').subscribe(function (attributes) {
                            _this.attributes = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_11__["filterCoreAttributes"])(attributes);
                            _this.notificator.showSuccess(_this.saveSuccessMessage);
                            _this.selection.clear();
                        });
                    });
                };
                GroupSettingsAttributesComponent.prototype.onDelete = function () {
                    var _this = this;
                ...
                GroupSettingsAttributesComponent.prototype.refreshTable = function () {
                    var _this = this;
                ...
                GroupSettingsAttributesComponent.prototype.applyFilter = function (filterValue) {
                    this.filterValue = filterValue;
                };
                return GroupSettingsAttributesComponent;
            }());
            GroupSettingsAttributesComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupSettingsExpirationComponent = /** @class */ (function () {
                function GroupSettingsExpirationComponent(attributesService, route, translate, notificator, apiRequest) {
                    ...
                    this.notificator = notificator;
                    this.apiRequest = apiRequest;
                    this.translate.get('GROUP_DETAIL.SETTINGS.EXPIRATION.SUCCESS_MESSAGE').subscribe(function (value) { return _this.successMessage = value; });
                    this.translate.get('GROUP_DETAIL.SETTINGS.EXPIRATION.ERROR_MESSAGE').subscribe(function (value) { return _this.errorMessage = value; });
                }
                GroupSettingsExpirationComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (params) {
                        _this.groupId = params['groupId'];
                        _this.loadSettings();
                ...
                GroupSettingsExpirationComponent.prototype.loadSettings = function () {
                    var _this = this;
                    this.attributesService.getAttribute(this.groupId, 'group', _perun_web_apps_perun_urns__WEBPACK_IMPORTED_MODULE_6__["Urns"].GROUP_DEF_EXPIRATION_RULES).subscribe(function (attr) {
                        _this.expirationAttribute = attr;
                    });
                };
                GroupSettingsExpirationComponent.prototype.saveExpirationAttribute = function (attribute) {
                    var _this = this;
                    // FIXME this might not work in case of some race condition (other request finishes sooner)
                    this.apiRequest.dontHandleErrorForNext();
                    this.attributesService.setAttribute(this.groupId, 'group', attribute, false).subscribe(function () {
                        _this.loadSettings();
                        _this.notificator.showSuccess(_this.successMessage);
                    }, function (error) { return _this.notificator.showRPCError(error, _this.errorMessage); });
                };
                return GroupSettingsExpirationComponent;
            }());
            GroupSettingsExpirationComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupSettingsManagersComponent = /** @class */ (function () {
                ...
                GroupSettingsManagersComponent.prototype.ngOnInit = function () {
                    var _this = this;
            ...
            GroupSettingsManagersComponent.ctorParameters = function () { return [
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_3__["GroupService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupSettingsNotificationsComponent = /** @class */ (function () {
                ...
                GroupSettingsNotificationsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                    this.route.parent.parent.params.subscribe(function (params) {
                        _this.voId = params['voId'];
                        ...
                        _this.registrarService.getApplicationFormForGroup(_this.groupId, false).subscribe(function (form) {
                            _this.applicationForm = form;
                            _this.registrarService.getApplicationMailsForGroup(_this.groupId).subscribe(function (mails) {
                                _this.applicationMails = mails;
                                _this.loading = false;
                            });
                        }, function (error) {
                            if (error.name === 'FormNotExistsException') {
                ...
                GroupSettingsNotificationsComponent.prototype.add = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translate.get('GROUP_DETAIL.SETTINGS.NOTIFICATIONS.ADD_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.selection.clear();
                            _this.updateTable();
                ...
                GroupSettingsNotificationsComponent.prototype.remove = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translate.get('GROUP_DETAIL.SETTINGS.NOTIFICATIONS.DELETE_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.selection.clear();
                            _this.updateTable();
                ...
                GroupSettingsNotificationsComponent.prototype.copy = function () {
                    var _this = this;
                ...
                GroupSettingsNotificationsComponent.prototype.updateTable = function () {
                    var _this = this;
                    this.loading = true;
                    this.registrarService.getApplicationMailsForGroup(this.groupId).subscribe(function (mails) {
                        _this.applicationMails = mails;
                ...
                GroupSettingsNotificationsComponent.prototype.changeEmailFooter = function () {
                ...
                GroupSettingsNotificationsComponent.prototype.changeSelection = function (selection) {
                    this.selection = selection;
                };
                GroupSettingsNotificationsComponent.prototype.createEmptyApplicationForm = function () {
                    var _this = this;
                    this.registrarService.createApplicationForm(this.groupId).subscribe(function () {
                        _this.noApplicationForm = false;
                        _this.ngOnInit();
            ...
            GroupSettingsNotificationsComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GroupSettingsOverviewComponent = /** @class */ (function () {
                ...
                GroupSettingsOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                GroupSettingsOverviewComponent.prototype.initItems = function () {
                    this.items = [
                        {
            ...
            GroupSettingsOverviewComponent.ctorParameters = function () { return [
                { type: _core_services_common_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _shared_animations_Animations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/animations/Animations */ "./src/app/shared/animations/Animations.ts");
            var GroupSettingsComponent = /** @class */ (function () {
                function GroupSettingsComponent() {
                }
                GroupSettingsComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var MemberDetailPageComponent = /** @class */ (function () {
                ...
                MemberDetailPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        var voId = params['voId'];
                        ...
                        _this.voService.getVoById(voId).subscribe(function (vo) {
                            _this.vo = vo;
                            _this.membersService.getRichMemberWithAttributes(memberId).subscribe(function (member) {
                                _this.member = member;
                                var voSideMenuItem = _this.sideMenuItemService.parseVo(_this.vo);
                                var memberSideMenuItem = _this.sideMenuItemService.parseMember(_this.member);
                                _this.fullName = memberSideMenuItem.label;
                                _this.sideMenuService.setAccessMenuItems([voSideMenuItem, memberSideMenuItem]);
                            });
                        });
                    });
                };
            ...
            MemberDetailPageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @perun-web-apps/perun/utils */ "../../libs/perun/utils/src/index.ts");
            var MemberOverviewComponent = /** @class */ (function () {
                ...
                MemberOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.params.subscribe(function (parentParams) {
                        var memberId = parentParams['memberId'];
                        _this.membersService.getRichMemberWithAttributes(memberId).subscribe(function (member) {
                            _this.member = member;
                            _this.fullName = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_6__["parseFullName"])(_this.member.user);
                            _this.statusIcon = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_6__["parseStatusIcon"])(_this.member);
                            _this.statusIconColor = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_6__["parseStatusColor"])(_this.member);
                            _this.initNavItems();
                            _this.attributeService.getAttribute(_this.member.id, 'member', _perun_web_apps_perun_urns__WEBPACK_IMPORTED_MODULE_5__["Urns"].MEMBER_DEF_EXPIRATION).subscribe(function (attr) {
                                _this.expiration = attr.value === null ? _this.translate.instant('MEMBER_DETAIL.OVERVIEW.NEVER_EXPIRES') : attr.value;
                            });
                        });
                    });
                };
                MemberOverviewComponent.prototype.initNavItems = function () {
                    this.navItems = [
                        {
                            icon: 'group-white.svg',
            ...
            MemberOverviewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            /* harmony import */ var _perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @perun-web-apps/perun/utils */ "../../libs/perun/utils/src/index.ts");
            var MemberSettingsAttributesComponent = /** @class */ (function () {
                function MemberSettingsAttributesComponent(route, attributesService, notificator, dialog, translate) {
                    ...
                    this.attributes = [];
                    this.filterValue = '';
                    this.translate.get('MEMBER_DETAIL.SETTINGS.ATTRIBUTES.SUCCESS_SAVE').subscribe(function (value) { return _this.saveSuccessMessage = value; });
                    this.translate.get('MEMBER_DETAIL.SETTINGS.ATTRIBUTES.SUCCESS_DELETE').subscribe(function (value) { return _this.deleteSuccessMessage = value; });
                }
                MemberSettingsAttributesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (params) {
                ...
                MemberSettingsAttributesComponent.prototype.onCreate = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(_shared_components_dialogs_create_attribute_dialog_create_attribute_dialog_component__WEBPACK_IMPORTED_MODULE_8__["CreateAttributeDialogComponent"], {
                        width: '1050px',
                        data: {
                ...
                MemberSettingsAttributesComponent.prototype.onSave = function () {
                    var _this = this;
                    // have to use this to update attribute with map in it, before saving it
                    this.list.updateMapAttributes();
                    this.attributesService.setAttributes(this.memberId, 'member', this.selection.selected).subscribe(function () {
                        _this.attributesService.getAllAttributes(_this.memberId, 'member').subscribe(function (attributes) {
                            _this.attributes = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_11__["filterCoreAttributes"])(attributes);
                            _this.notificator.showSuccess(_this.saveSuccessMessage);
                            _this.selection.clear();
                        });
                ...
                MemberSettingsAttributesComponent.prototype.onDelete = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(_shared_components_dialogs_delete_attribute_dialog_delete_attribute_dialog_component__WEBPACK_IMPORTED_MODULE_9__["DeleteAttributeDialogComponent"], {
                        width: '450px',
                        data: {
                ...
                MemberSettingsAttributesComponent.prototype.refreshTable = function () {
                    var _this = this;
                    this.loading = true;
                ...
                MemberSettingsAttributesComponent.prototype.applyFilter = function (filterValue) {
                    this.filterValue = filterValue;
                };
                return MemberSettingsAttributesComponent;
            }());
            MemberSettingsAttributesComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_10__["AttributesService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var MemberSettingsOverviewComponent = /** @class */ (function () {
                ...
                MemberSettingsOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (grandParentParams) {
                        var voId = grandParentParams['voId'];
                        var memberId = grandParentParams['memberId'];
                        _this.memberService.getMemberById(memberId).subscribe(function (member) {
                            _this.member = member;
                            _this.voService.getVoById(voId).subscribe(function (vo) {
                                _this.vo = vo;
                                _this.initItems();
                ...
                MemberSettingsOverviewComponent.prototype.initItems = function () {
                    this.items = [
                        {
                            icon: 'attributes-white.svg',
            ...
            MemberSettingsOverviewComponent.ctorParameters = function () { return [
                { type: _core_services_common_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__["VoService"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__["MembersService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _shared_animations_Animations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/animations/Animations */ "./src/app/shared/animations/Animations.ts");
            var MemberSettingsComponent = /** @class */ (function () {
                function MemberSettingsComponent() {
                }
                MemberSettingsComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VoDetailPageComponent = /** @class */ (function () {
                ...
                VoDetailPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        var voId = params['voId'];
                        _this.voService.getVoById(voId).subscribe(function (vo) {
                            _this.vo = vo;
                            var sideMenuItem = _this.sideMenuItemService.parseVo(vo);
                            _this.sideMenuService.setAccessMenuItems([sideMenuItem]);
                            Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_7__["addRecentlyVisited"])('vos', _this.vo);
                        });
                    });
                };
                return VoDetailPageComponent;
            }());
            VoDetailPageComponent.ctorParameters = function () { return [
                { type: _core_services_common_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_6__["VoService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var VoOverviewComponent = /** @class */ (function () {
                ...
                VoOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.params.subscribe(function (parentParams) {
                ...
                VoOverviewComponent.prototype.initNavItems = function () {
                    // Members
                ...
                VoOverviewComponent.prototype.initItems = function () {
                    this.items = [
                        {
            ...
            VoOverviewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var VoResourcesOverviewComponent = /** @class */ (function () {
                ...
                VoResourcesOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                VoResourcesOverviewComponent.prototype.initItems = function () {
                    this.items = [
                        {
            ...
            VoResourcesOverviewComponent.ctorParameters = function () { return [
                { type: _core_services_common_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__["VoService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "../../node_modules/@angular/material/esm2015/material.js");
            var StateTabComponent = /** @class */ (function () {
                function StateTabComponent() {
                    this.propagation = [];
                    this.datasources = [];
                    this.displayedColumns = ['id', 'service', 'status', 'scheduled', 'started', 'ended'];
                }
                StateTabComponent.prototype.ngOnInit = function () {
                    this.getDataSource();
                };
                StateTabComponent.prototype.getErrorCountStates = function (resourceStatus) {
                    var counter = 0;
                    for (var _i = 0, _a = resourceStatus.taskList; _i < _a.length; _i++) {
                        var task = _a[_i];
                ...
                StateTabComponent.prototype.getDataSource = function () {
                    for (var _i = 0, _a = this.propagation; _i < _a.length; _i++) {
                        var resourceState = _a[_i];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VoResourcesTagsComponent = /** @class */ (function () {
                ...
                VoResourcesTagsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (parentParams) {
                        _this.voId = parentParams['voId'];
                        _this.updateData();
                    });
                };
                VoResourcesTagsComponent.prototype.deleteTag = function () {
                    var _this = this;
                    ...
                    dialogRef.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translator.get('VO_DETAIL.RESOURCES.TAGS.DELETE_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.updateData();
                        }
                ...
                VoResourcesTagsComponent.prototype.create = function () {
                    var _this = this;
                    ...
                    dialogRef.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translator.get('VO_DETAIL.RESOURCES.TAGS.CREATE_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.updateData();
                        }
                ...
                VoResourcesTagsComponent.prototype.updateData = function () {
                    var _this = this;
                    this.loading = true;
                    this.selection.clear();
                    this.resourceService.getAllResourcesTagsForVo(this.voId).subscribe(function (tags) {
                        _this.resourceTag = tags;
                        _this.loading = false;
                    });
                };
                VoResourcesTagsComponent.prototype.applyFilter = function (filterValue) {
                    this.filterValue = filterValue;
                };
                return VoResourcesTagsComponent;
            }());
            VoResourcesTagsComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VoResourcesComponent = /** @class */ (function () {
                function VoResourcesComponent(route) {
                    this.route = route;
                }
                VoResourcesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.params.subscribe(function (parentParams) {
                        _this.voId = parentParams['voId'];
                    });
            ...
            VoResourcesComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"])('class.router-component'),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var VoSettingsApplicationFormComponent = /** @class */ (function () {
                ...
                VoSettingsApplicationFormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                    this.route.parent.parent.params.subscribe(function (params) {
                        var voId = params['voId'];
                        _this.voId = voId;
                        _this.registrarService.getApplicationFormForVo(voId).subscribe(function (form) {
                            _this.applicationForm = form;
                            _this.registrarService.getFormItemsForVo(voId).subscribe(function (formItems) {
                                _this.applicationFormItems = formItems;
                                _this.loading = false;
                ...
                VoSettingsApplicationFormComponent.prototype.add = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.registrarService.getFormItemsForVo(_this.voId).subscribe(function (formItems) {
                                _this.applicationFormItems = formItems;
                                var editDialog = _this.dialog.open(_shared_components_dialogs_edit_application_form_item_dialog_edit_application_form_item_dialog_component__WEBPACK_IMPORTED_MODULE_9__["EditApplicationFormItemDialogComponent"], {
                                    width: '600px',
                                    height: '600px',
                                    data: { voId: _this.voId, applicationFormItem: formItems[success.ordnum], applicationFormItems: _this.applicationFormItems }
                                });
                                editDialog.afterClosed().subscribe(function () {
                                    _this.updateFormItems();
                                });
                ...
                VoSettingsApplicationFormComponent.prototype.copy = function () {
                    var _this = this;
                ...
                VoSettingsApplicationFormComponent.prototype.settings = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (newForm) {
                        if (newForm) {
                            _this.translate.get('VO_DETAIL.SETTINGS.APPLICATION_FORM.CHANGE_SETTINGS_SUCCESS').subscribe(function (successMessage) {
                                _this.notificator.showSuccess(successMessage);
                            });
                            _this.applicationForm = newForm;
                        }
                ...
                VoSettingsApplicationFormComponent.prototype.preview = function () {
                    this.router.navigate(['/organizations', this.voId, 'settings', 'applicationForm', 'preview']);
                };
                VoSettingsApplicationFormComponent.prototype.updateFormItems = function () {
                    var _this = this;
                    this.loading = true;
                ...
                VoSettingsApplicationFormComponent.prototype.changeItems = function (applicationFormItemsChange) {
                    this.applicationFormItems = applicationFormItemsChange;
                };
                return VoSettingsApplicationFormComponent;
            }());
            VoSettingsApplicationFormComponent.ctorParameters = function () { return [
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_10__["RegistrarService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] },
                { type: _core_services_common_notificator_service__WEBPACK_IMPORTED_MODULE_5__["NotificatorService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VoSettingsAttributesComponent = /** @class */ (function () {
                function VoSettingsAttributesComponent(attributesService, sideMenuService, voService, route, dialog, notificator, translate) {
                    ...
                    this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_3__["SelectionModel"](true, []);
                    this.filterValue = '';
                    this.translate.get('VO_DETAIL.SETTINGS.ATTRIBUTES.SUCCESS_SAVE').subscribe(function (value) { return _this.saveSuccessMessage = value; });
                    this.translate.get('VO_DETAIL.SETTINGS.ATTRIBUTES.SUCCESS_DELETE').subscribe(function (value) { return _this.deleteSuccessMessage = value; });
                }
                VoSettingsAttributesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (parentParams) {
                        _this.voId = parentParams['voId'];
                        _this.refreshTable();
                ...
                VoSettingsAttributesComponent.prototype.onDelete = function () {
                    var _this = this;
                ...
                VoSettingsAttributesComponent.prototype.onCreate = function () {
                    var _this = this;
                ...
                VoSettingsAttributesComponent.prototype.onSave = function () {
                    var _this = this;
                    // have to use this to update attribute with map in it, before saving it
                    this.list.updateMapAttributes();
                    this.attributesService.setAttributes(this.voId, 'vo', this.selection.selected).subscribe(function () {
                        _this.attributesService.getAllAttributes(_this.voId, 'vo').subscribe(function (attributes) {
                ...
                VoSettingsAttributesComponent.prototype.refreshTable = function () {
                    var _this = this;
                    this.loading = true;
                ...
                VoSettingsAttributesComponent.prototype.applyFilter = function (filterValue) {
                    this.filterValue = filterValue;
                };
                return VoSettingsAttributesComponent;
            }());
            VoSettingsAttributesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VoSettingsExpirationComponent = /** @class */ (function () {
                function VoSettingsExpirationComponent(attributesService, route, translate, notificator, apiRequest) {
                    ...
                    this.notificator = notificator;
                    this.apiRequest = apiRequest;
                    this.translate.get('VO_DETAIL.SETTINGS.EXPIRATION.SUCCESS_MESSAGE').subscribe(function (value) { return _this.successMessage = value; });
                    this.translate.get('VO_DETAIL.SETTINGS.EXPIRATION.ERROR_MESSAGE').subscribe(function (value) { return _this.errorMessage = value; });
                }
                VoSettingsExpirationComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (params) {
                        _this.voId = params['voId'];
                        _this.loadSettings();
                ...
                VoSettingsExpirationComponent.prototype.loadSettings = function () {
                    var _this = this;
                ...
                VoSettingsExpirationComponent.prototype.saveExpirationAttribute = function (attribute) {
                    var _this = this;
                    // FIXME this might not work in case of some race condition (other request finishes sooner)
                    this.apiRequest.dontHandleErrorForNext();
                    this.attributesService.setAttribute(this.voId, 'vo', attribute, false).subscribe(function () {
                        ...
                        console.log(error);
                        _this.notificator.showRPCError(error, _this.errorMessage);
                    });
                };
                return VoSettingsExpirationComponent;
            }());
            VoSettingsExpirationComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
            var VoSettingsExtsourcesComponent = /** @class */ (function () {
                function VoSettingsExtsourcesComponent() {
                }
                VoSettingsExtsourcesComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            /* harmony import */ var _perun_web_apps_perun_models__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @perun-web-apps/perun/models */ "../../libs/perun/models/src/index.ts");
            var VoSettingsManagersComponent = /** @class */ (function () {
                ...
                VoSettingsManagersComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (parentParentParams) {
            ...
            VoSettingsManagersComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__["VoService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            /* harmony import */ var _perun_web_apps_perun_models__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @perun-web-apps/perun/models */ "../../libs/perun/models/src/index.ts");
            var VoSettingsNotificationsComponent = /** @class */ (function () {
                ...
                VoSettingsNotificationsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                    this.route.parent.parent.params.subscribe(function (params) {
                        _this.voId = params['voId'];
                        _this.registrarService.getApplicationFormForVo(_this.voId).subscribe(function (form) {
                            _this.applicationForm = form;
                            _this.registrarService.getApplicationMailsForVo(_this.voId).subscribe(function (mails) {
                                _this.applicationMails = mails;
                                _this.loading = false;
                            });
                        });
                ...
                VoSettingsNotificationsComponent.prototype.add = function () {
                    var _this = this;
                    var applicationMail = new _perun_web_apps_perun_models__WEBPACK_IMPORTED_MODULE_12__["ApplicationMail"]();
                    applicationMail.formId = this.applicationForm.id;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translate.get('VO_DETAIL.SETTINGS.NOTIFICATIONS.ADD_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.selection.clear();
                            _this.updateTable();
                ...
                VoSettingsNotificationsComponent.prototype.remove = function () {
                    var _this = this;
                    ...
                    dialog.afterClosed().subscribe(function (success) {
                        if (success) {
                            _this.translate.get('VO_DETAIL.SETTINGS.NOTIFICATIONS.DELETE_SUCCESS').subscribe(function (text) {
                                _this.notificator.showSuccess(text);
                            });
                            _this.selection.clear();
                            _this.updateTable();
                ...
                VoSettingsNotificationsComponent.prototype.copy = function () {
                    var _this = this;
                ...
                VoSettingsNotificationsComponent.prototype.updateTable = function () {
                    var _this = this;
                    this.loading = true;
                    this.registrarService.getApplicationMailsForVo(this.voId).subscribe(function (mails) {
                        _this.applicationMails = mails;
                ...
                VoSettingsNotificationsComponent.prototype.changeEmailFooter = function () {
                ...
                VoSettingsNotificationsComponent.prototype.changeSelection = function (selection) {
                    this.selection = selection;
                };
                return VoSettingsNotificationsComponent;
            }());
            VoSettingsNotificationsComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_11__["RegistrarService"] },
                { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @perun-web-apps/perun/services */ "../../libs/perun/services/src/index.ts");
            var VoSettingsOverviewComponent = /** @class */ (function () {
                ...
                VoSettingsOverviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.parent.params.subscribe(function (parentParams) {
                        var voId = parentParams['voId'];
                        _this.voService.getVoById(voId).subscribe(function (vo) {
                ...
                VoSettingsOverviewComponent.prototype.initItems = function () {
                    this.items = [
                        {
                            icon: 'attributes-white.svg',
            ...
            VoSettingsOverviewComponent.ctorParameters = function () { return [
                { type: _core_services_common_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
                { type: _perun_web_apps_perun_services__WEBPACK_IMPORTED_MODULE_4__["VoService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _shared_animations_Animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/animations/Animations */ "./src/app/shared/animations/Animations.ts");
            var VoSettingsComponent = /** @class */ (function () {
                function VoSettingsComponent(route, router) {
                    ...
                    router.events.subscribe(function (_) {
                        if (_ instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
                            ...
                            _this.backButtonDisplayed = _this.backButtonRegex.test(_this.currentUrl);
                        }
                    });
                }
                VoSettingsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.params.subscribe(function (parentParams) {
                        _this.voId = parentParams['voId'];
                    });
            ...
            VoSettingsComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VoSelectPageComponent = /** @class */ (function () {
                ...
                VoSelectPageComponent.prototype.ngOnInit = function () {
                    this.loading = true;
                ...
                VoSelectPageComponent.prototype.refreshTable = function () {
                    var _this = this;
                    this.loading = true;
                    this.selection.clear();
                    this.voService.getVos().subscribe(function (vos) {
                        _this.vos = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_4__["getRecentlyVisited"])('vos', vos);
                        _this.recentIds = Object(_perun_web_apps_perun_utils__WEBPACK_IMPORTED_MODULE_4__["getRecentlyVisitedIds"])('vos');
                        _this.loading = false;
                    });
                };
                VoSelectPageComponent.prototype.applyFilter = function (filterValue) {
                    this.filterValue = filterValue;
                };
                VoSelectPageComponent.prototype.onCreateVo = function () {
                    var _this = this;
                ...
                VoSelectPageComponent.prototype.onRemoveVo = function () {
                    var _this = this;
            ...
            VoSelectPageComponent.ctorParameters = function () { return [
                { type: _core_services_common_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VosRoutingModule = /** @class */ (function () {
                function VosRoutingModule() {
                }
